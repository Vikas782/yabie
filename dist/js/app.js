...
var swiper = new Swiper('.swiper', {}); // trigger popover
...
window.cf = {
  ...
  wrap: function wrap(el, wrapper, classlist) {
  ...
  viewPort: function viewPort(eleSelector, opts) {
    var defaults = {
      speed: 1,
      position: 0.85,
      onLoad: function onLoad() {},
      onViewPort: function onViewPort() {},
      offViewPort: function offViewPort() {}
    };
    ...
    elems.forEach(function (elem, index) {
      ...
      function scrolledContent() {
        ...
        var eleHeight = elem.offsetHeight;
        var scrollerPosition = window.pageYOffset || document.documentElement.scrollTop;
        var eleTopPosition = cf.getOffsetTop(elem);
        var topPosition;
  ...
  triggerViewPort: function triggerViewPort(eleSelector, opts) {
    var defaults = {
    ...
    elems.forEach(function (elem, index) {
      ...
      function scrolledContent() {
        var ScrollerPosition = window.scrollY;
        var eleTopPosition = cf.getOffsetTop(elem);
  ...
  fixedHeader: function fixedHeader(eleSelector, opts) {
    var defaults = {};
    var options = cf.extend(defaults, opts);
    ...
    var headerHt = header.clientHeight;
    var lastScrollTop = 0;
    var button = header.querySelector('[data-bs-toggle="collapse"]');
    var myCollapse;

    if (button) {
      var buttonid = button.getAttribute("data-bs-target");
  ...
  pageLoader: function pageLoader(eleSelector, opts) {
    var defaults = {
      duration: 0.4,
      nextElement: null
    };
  ...
  smoothScroller: function smoothScroller(eleSelector, opts) {
    var defaults = {
      ease: 0.07,
      // <= scroll speed
      endY: 0,
...
window.counter = {
  numberCountSet: function numberCountSet(elem) {
    var elements = elem.querySelectorAll("[data-counter]");
    elements.forEach(function (element, index) {
      element.innerHTML = 0;
    });
  },
  numberCount: function numberCount(elem) {
    var elements = elem.querySelectorAll("[data-counter]");
    elements.forEach(function (element, index) {
      var x = 0;
      var count = parseInt(element.getAttribute("data-counter"));
      var myInterval = setInterval(myCounter, 40);
...
window.animate = {
  landingSet: function landingSet(elem, index) {
  ...
  headingSet: function headingSet(elem) {
  ...
  slideupSet: function slideupSet(elem) {
...
window.pAnimate = {
  sideNavFixedSet: function sideNavFixedSet(elem) {
    gsap.set(".sidebar", {
      y: 0
    });
  },
  sideNavFixed: function sideNavFixed(elem, scroller, topPosition) {
    if (screen.width < 768) {
  ...
  landingSet: function landingSet(elem) {
    gsap.set(elem.querySelector(".scroll-down-circle"), {
      opacity: "0",
      x: 0
    });
  },
  landing: function landing(elem, scroller, topPosition) {
    var opacity;
    var oVal;
...
cf.smoothScroller("#scroller", {//ease: 0.09,
}); //
